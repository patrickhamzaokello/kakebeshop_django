...
class UserAddress(models.Model):
    ...
    latitude = models.DecimalField(max_digits=60, decimal_places=8, null=True, blank=True)
    longitude = models.DecimalField(max_digits=60, decimal_places=8, null=True, blank=True)
