...
class AddPhoneNumberSerializer(serializers.Serializer):
    ...
    def validate_phone(self, value):
        ...
        try:
            ...
            # Format to E.164 (e.g., +256700000000)
            ...
            raise serializers.ValidationError(
                "Invalid phone number format. Please include country code (e.g., +256700000000)"
            )
    ...
    def validate(self, attrs):
        ...
        if request and request.user:
            ...
            if existing_user:
                raise serializers.ValidationError({
                    'phone': 'This phone number is already registered and verified'
                })
...
class ResendPhoneVerificationSerializer(serializers.Serializer):
    ...
    No fields needed as we use the authenticated user's phone
    """
    pass